    ...
    const onPaste = (0, react_1.useCallback)((event) => {
        ...
        if (activeCell && !editing) {
            ...
            if ((_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.types.includes('text/plain')) {
                pasteData = (0, copyPasting_1.parseTextPlainData)((_b = event.clipboardData) === null || _b === void 0 ? void 0 : _b.getData('text/plain'));
            }
            else if ((_c = event.clipboardData) === null || _c === void 0 ? void 0 : _c.types.includes('text/html')) {
                pasteData = (0, copyPasting_1.parseTextHtmlData)((_d = event.clipboardData) === null || _d === void 0 ? void 0 : _d.getData('text/html'));
            }
