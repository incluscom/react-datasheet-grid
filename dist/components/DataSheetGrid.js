...
exports.DataSheetGrid = react_1.default.memo(react_1.default.forwardRef(({ value: data = DEFAULT_DATA, className, style, height: maxHeight = 400, onChange = DEFAULT_EMPTY_CALLBACK, columns: rawColumns = DEFAULT_COLUMNS, rowHeight = 40, headerRowHeight = typeof rowHeight === 'number' ? rowHeight : 40, gutterColumn, stickyRightColumn, rowKey, addRowsComponent: AddRowsComponent = AddRows_1.AddRows, createRow = DEFAULT_CREATE_ROW, autoAddRow = false, lockRows = false, disableExpandSelection = false, disableSmartDelete = false, duplicateRow = DEFAULT_DUPLICATE_ROW, contextMenuComponent: ContextMenuComponent = ContextMenu_1.ContextMenu, disableContextMenu: disableContextMenuRaw = false, onFocus = DEFAULT_EMPTY_CALLBACK, onBlur = DEFAULT_EMPTY_CALLBACK, onActiveCellChange = DEFAULT_EMPTY_CALLBACK, onSelectionChange = DEFAULT_EMPTY_CALLBACK, rowClassName, cellClassName, onScroll, pasteHandler, copyHandler, }, ref) => {
    ...
    const onPaste = (0, react_1.useCallback)((event) => {
        ...
        if (activeCell && !editing) {
            ...
            if (pasteHandler) {
                let pasteString = '';
                if ((_a = event.clipboardData) === null || _a === void 0 ? void 0 : _a.types.includes('text/plain')) {
                    pasteString = (_b = event.clipboardData) === null || _b === void 0 ? void 0 : _b.getData('text/plain');
                }
                else if ((_c = event.clipboardData) === null || _c === void 0 ? void 0 : _c.types.includes('text')) {
                    pasteString = (_d = event.clipboardData) === null || _d === void 0 ? void 0 : _d.getData('text');
                }
                pasteData = pasteHandler(pasteString);
            }
            else if ((_e = event.clipboardData) === null || _e === void 0 ? void 0 : _e.types.includes('text/html')) {
                pasteData = (0, copyPasting_1.parseTextHtmlData)((_f = event.clipboardData) === null || _f === void 0 ? void 0 : _f.getData('text/html'));
            }
            else if ((_g = event.clipboardData) === null || _g === void 0 ? void 0 : _g.types.includes('text/plain')) {
                pasteData = (0, copyPasting_1.parseTextPlainData)((_h = event.clipboardData) === null || _h === void 0 ? void 0 : _h.getData('text/plain'));
            }
            else if ((_j = event.clipboardData) === null || _j === void 0 ? void 0 : _j.types.includes('text')) {
                pasteData = (0, copyPasting_1.parseTextPlainData)((_k = event.clipboardData) === null || _k === void 0 ? void 0 : _k.getData('text'));
            }
